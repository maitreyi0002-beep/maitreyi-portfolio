...
function images(markers) {
  ...
  if(s.includes('welcome / onboarding')) return grid([['onboarding.png','Welcome and onboarding'],['account-menu.png','Account menu'],['artifact-color.png','Artifact and color components'],['composer.png','Composer and input components'],['sidebar.png','Sidebar navigation'],['artifact-settings.png','Artifact settings panel']],'components');
